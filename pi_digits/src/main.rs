...
fn get_pi_monte_carlo(digits: u32) -> f64 {
    let base: u64 = 10;
    let points_count: u64 = base.pow(2 * digits);

    let inside: u64 = get_points(points_count);
    return 4.0 * inside as f64 / points_count as f64;
}
...
fn get_pi_monte_carlo_multithreaded(digits: u32) -> f64 {
    ...
    sub_cycles.push(points_count as u64 / cpu_count as u64 + points_count as u64 % cpu_count as u64);
